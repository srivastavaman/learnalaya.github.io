...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11"style={{ borderRadius: '1rem' }}>
      ...
      <div>
        ...
        <input
          type="submit"
          value="Subscribe Now"
          className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark "style={{ borderRadius: '1rem' }}
        />
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#3FFF0B" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
