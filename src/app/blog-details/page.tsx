...
export const metadata: Metadata = {
  title: "Blog Details Page | Free Next.js Template for Startup and Learnalaya",
      ...
      <section className="pb-[120px] pt-[150px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12 lg: border border-green shadow-lg" style={{ borderRadius: '1rem' }}>
              <div>
                <h2 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  10 amazing sites to download stock photos & digital assets for
                  free
                </h2>
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10"style={{ borderRadius: '1rem' }}>
                ...
                <div className="w-full px-4" style={{ borderRadius: '1rem' }}>
